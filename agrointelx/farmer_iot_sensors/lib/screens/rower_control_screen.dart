        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              ...
              duration: const Duration(milliseconds: 800),
              backgroundColor:
                  turnOn ? Colors.amber.shade700 : Colors.grey.shade700,
            ),
          );
        }
      }
      ...
      if (response.statusCode == 200) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                '${TranslationService().translate('sow')} ${turnOn ? "ON" : "OFF"} 🌱',
              ),
              duration: const Duration(milliseconds: 800),
              backgroundColor:
                  turnOn ? Colors.green.shade700 : Colors.grey.shade700,
            ),
          );
        }
      }
      ...
      if (response.statusCode == 200) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                '${TranslationService().translate('cut')} ${turnOn ? "ON" : "OFF"} 🌾',
              ),
              duration: const Duration(milliseconds: 800),
              backgroundColor:
                  turnOn ? Colors.orange.shade700 : Colors.grey.shade700,
            ),
          );
        }
      }
